                  ...
                  <div className="column-2">
                    {val?.Users.map((val, index) => {
                      return (
                        <>
                          <div
                            className="border-[2px] border-[#4B6CC2] rounded-lg flex items-center justify-center px-4 py-1 gap-2 cursor-pointer hover:scale-105 transition-all active:scale-95 ease-in-out"
                            onClick={() =>
